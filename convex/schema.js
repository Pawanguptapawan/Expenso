...
export default defineSchema({
  ...
  // .index()	 by_token	 ["tokenIdentifier"]	For fast lookup by token ID.
  // .index()	 by_email	           ["email"]	For fast lookup by email.
  // .searchIndex()  	search_name	  { searchField: "name" }	 Enables full-text search on the name field.
  // .searchIndex() 	search_email  { searchField: "email" }	 Enables full-text search on the email field.
